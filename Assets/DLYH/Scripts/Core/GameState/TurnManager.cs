...
namespace TecVooDoo.DontLoseYourHead.Core.GameState
{
    ...
    public class TurnManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// Initialize and start the first turn (called by GameStateMachine)
        /// </summary>
        public void StartFirstTurn()
        {
            ...
            Debug.Log("[TurnManager] Starting first turn for Player 1");

            // Start the first turn immediately (no delay for first turn)
            StartTurn();
        }
