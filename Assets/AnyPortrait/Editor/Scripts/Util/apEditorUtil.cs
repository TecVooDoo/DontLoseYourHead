...
namespace AnyPortrait
{
	...
	public static class apEditorUtil
	{
		...
		private static IEnumerator Crt_RequestCurrentVersion()
		{
			...
			{
				//중국 스토어 버전이라면 주소가 다르다.
				url = "https://rainyrizzle.github.io/CurrentVersion_CN.html";//변경 [1.4.2] Github 주소로 이동
			}
		...
		public static void OpenAssetStorePage()
		{
			...
			{
				//중국 스토어 (웹브라우저)
				Application.OpenURL("https://assetstore.u3d.cn/packages/slug/20000650");
			}
			else
			{
				//글로벌 스토어 (내부 링크)
