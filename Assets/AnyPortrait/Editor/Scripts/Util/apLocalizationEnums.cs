...
{
	// Automatically generated Enum variables
	public enum TEXT : int
	{
		...
		DLG_RemoveMask_Title = 876,
		DLG_RemoveMask_Body = 877,
		Masks = 878,
		AddMask = 879,
		RenderTextureSettings = 880,
		ShaderType = 881,
		ShaderAsset = 882,
		PassIndex = 883,
		TextureSize = 884,
		...
		SharedTexture = 886,
		SourceMesh = 887,
		DestinationMeshes = 888,
		DLG_RemoveDestination_Title = 889,
		DLG_RemoveDestination_Body = 890,
		AddDestinationMesh = 891,
		DLG_RemoveProperty_Title = 892,
		DLG_RemoveProperty_Body = 893,
		Channel = 894,
		ReservedProperties = 895,
		CustomProperties = 896,
		TargetOfAnotherMask = 897,
		Setting_CheckOptionForProjectWhenBake = 898,
		DLG_BakeCompatibilityWarn_Title = 899,
		DLG_BakeCompatibilityWarn_Body = 900,
		DLG_BakeCompatibilityWarn_ShadersForURP = 901,
		DLG_BakeCompatibilityWarn_MultiCamera = 902,
		FixIssues = 903,
		IgnoreAndBake = 904,
		ValidateOptions = 905,
		Checklist = 906,
		BakeValidation_RP_Pass = 907,
		BakeValidation_RP_Failed = 908,
		BakeValidation_PleaseSetOption = 909,
		BakeValidation_RP_UnknownRP = 910,
		BakeDialog = 911,
		BakeValidation_Shader_Pass = 912,
		BakeValidation_Shader_BTWarning = 913,
		BakeValidation_Shader_Failed = 914,
		BakeValidation_OpenMaterialLibrary = 915,
		BakeValidation_ColorSpace_Pass = 916,
		BakeValidation_ColorSpace_Failed = 917,
		Camera = 918,
		BakeValidation_Camera_Pass = 919,
		BakeValidation_Camera_MultiClipped = 920,
		BakeValidation_Camera_VR = 921,
		BakeValidation_Camera_Failed = 922,
		BakeValidation_Camera_FailedSolution = 923,
		MultipleCameras = 924,
		AlwaysCheckBakeOption = 925,
		RenderOrder = 926,
		SyncSharedTextureOptions = 927,
		DLG_SendMaskData_SyncOptions_Title = 928,
		DLG_SendMaskData_SyncOptions_Body = 929,
		SyncAllOptions = 930,
		SyncExceptShader = 931,
		Phase = 932,
		CopiedProperties = 933,
	}
	...
	public enum UIWORD : int
	{
		...
		Stretch = 492,
		Snapshot = 493,
		OpenMaskSettings = 494,
		MoveSymmetry = 495,
		MoveToPivot = 496,
		AsMaskOnly = 497,
		GUIMenu_ShowMeshesWithoutMask = 498,
	}
	
	// -------
	
	public enum TEXTV3 : int
	{
		None = 0,
		SetCenterAsPivot = 1,
		DLG_PivotToCenterFailed_Title = 2,
		DLG_PivotToCenterFailed_Body = 3,
	}
