...
namespace AnyPortrait
{
	...
	public class apImageSet
	{
		...
		public ReloadResult ReloadImages()
		{
			...
			CheckImageAndLoad(PRESET.StartPage_AssetStore, "StartPage_AssetStore");
			CheckImageAndLoad(PRESET.StartPage_Homepage, "StartPage_Homepage");
			CheckImageAndLoad(PRESET.StartPage_QnA, "StartPage_QnA");
			CheckImageAndLoad(PRESET.StartPage_ReportBug, "StartPage_ReportBug");
			CheckImageAndLoad(PRESET.StartPage_Scripting, "StartPage_Scripting");
