		...
		public void Init(apEditor editor, apEditor.LANGUAGE language)
		{
			...
			switch (_language)
			{
				case apEditor.LANGUAGE.Korean:
					_url_LeranMore = "https://rainyrizzle.github.io/kr/AdvancedManual/AD_PerformanceMac.html";
					break;

				case apEditor.LANGUAGE.Japanese:
					_url_LeranMore = "https://rainyrizzle.github.io/jp/AdvancedManual/AD_PerformanceMac.html";
					break;

				default:
					_url_LeranMore = "https://rainyrizzle.github.io/en/AdvancedManual/AD_PerformanceMac.html";
					break;
			}
