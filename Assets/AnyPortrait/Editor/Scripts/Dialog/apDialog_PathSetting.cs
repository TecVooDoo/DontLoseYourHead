...
namespace AnyPortrait
{
	public class apDialog_PathSetting : EditorWindow
	{
		...
		{	
			...
			apEditor.LANGUAGE defaultLang = apEditor.LANGUAGE.English;
			if(apVersion.I.IsCNStore)
			{
				defaultLang = apEditor.LANGUAGE.Chinese_Simplified;
			}
			_language = (apEditor.LANGUAGE)EditorPrefs.GetInt(apVersion.I.LanguagePrefKey, (int)defaultLang);//AnyPortrait_Language
