	...
	public partial class apEditor : EditorWindow
	{
		...
		private bool CheckEditorResources()
		{
			...
			if (_localization.CheckToReloadLanguage(_language))//언어 비교
			{
				...
				_localization.LoadTextAsset(_language);
		...
		public void SaveEditorPref()
		{
			...
			SavePref_Int(apVersion.I.LanguagePrefKey, (int)_language, (int)DefaultLanguage);//EditorPrefs.SetInt("AnyPortrait_Language", (int)_language);
		...
		public void LoadEditorPref()
		{
			...
			_language = (LANGUAGE)EditorPrefs.GetInt(apVersion.I.LanguagePrefKey, (int)DefaultLanguage);
		...
		{
			return _localization.GetText(textType);
		}


		public string GetTextFormat(TEXT textType, params object[] paramList)
		{
			return string.Format(_localization.GetText(textType), paramList);
		}


		public string GetUIWord(UIWORD uiWordType)
		{
			return _localization.GetUIWord(uiWordType);
		}


		public string GetUIWordFormat(UIWORD uiWordType, params object[] paramList)
		{
			return string.Format(_localization.GetUIWord(uiWordType), paramList);
		}

		public string GetTextV3(TEXTV3 textV3Type)
		{
			return _localization.GetTextV3(textV3Type);
		}

		public string GetTextFormatV3(TEXTV3 textV3Type, params object[] paramList)
		{
			return string.Format(_localization.GetTextV3(textV3Type), paramList);
		}
