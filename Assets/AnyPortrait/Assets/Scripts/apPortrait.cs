...
// 					}
									...
									bool isAutoEndIfNotloop = false)
		{
			...
			try
			{
				...
				{
#if UNITY_EDITOR
					Debug.LogError("AnyPortrait : AnimPlayData is null.");
#endif
					return null;
				}
		...
		// 추가 1.6.1
		// 프레임만 변경 / 프레임 변경 후 일시정지
		/// <summary>
		/// Change the frame of the currently playing animation.
		/// This function will not work if the animation is not playing. In that case, use PlayAt or PauseAt.
		/// </summary>
		/// <param name="animClipName">Name of the Animation Clip</param>
		/// <param name="frame">Frame at the time the animation is played</param>
		/// <param name="isPauseAfterFrameChanged">If True, the animation will pause. If False, the animation will remain in its current playback state.</param>
		/// <returns>Animation data to be played. If it fails, null is returned.</returns>
		public apAnimPlayData ChangeFrame(string animClipName, int frame, bool isPauseAfterFrameChanged = false)
		{
#if UNITY_EDITOR
			try
			{
				...
				if(animPlayData.PlaybackStatus == apAnimPlayData.AnimationPlaybackStatus.None)
				{
#if UNITY_EDITOR
					Debug.LogError("AnyPortrait : ChangeFrame function cannot be executed on an animation that is not playing.");
#endif
					return null;
				}

				_animPlayDeferredRequest.ChangeFrame(animPlayData, frame, isPauseAfterFrameChanged);
		...
		/// <param name="isPauseAfterFrameChanged">If True, the animation will pause. If False, the animation will remain in its current playback state.</param>
		/// <returns>Animation data to be played. If it fails, null is returned.</returns>		
		public apAnimPlayData ChangeFrame(apAnimPlayData animPlayData, int frame, bool isPauseAfterFrameChanged = false)
		{
#if UNITY_EDITOR
			try
			{
		...
		/// <summary>
		/// Jump the animation to a specific frame and pauses it as soon as it starts playing.
		/// </summary>
		/// <param name="animClipName">Name of the Animation Clip</param>
		/// <param name="frame">Frame at the time the animation is played</param>
		/// <param name="layer">The layer to which the animation is applied. From 0 to 20</param>
		/// <param name="blendMethod">How it is blended with the animation of the lower layers</param>
		/// <param name="playOption">How to stop which animations</param>
		/// <param name="isAutoEndIfNotloop">If True, animation that does not play repeatedly is automatically terminated. (When Resume)</param>
		/// <returns>Animation data to be played. If it fails, null is returned.</returns>
		public apAnimPlayData PauseAt(string animClipName, int frame,
									int layer = 0,
									apAnimPlayUnit.BLEND_METHOD blendMethod = apAnimPlayUnit.BLEND_METHOD.Interpolation,
									apAnimPlayManager.PLAY_OPTION playOption = apAnimPlayManager.PLAY_OPTION.StopSameLayer,
									bool isAutoEndIfNotloop = false)
		{
			...
			try
			{
				...
				_animPlayDeferredRequest.PauseAt(animPlayData, frame, layer, blendMethod, playOption, isAutoEndIfNotloop);
				return animPlayData;
		...
		/// <param name="isAutoEndIfNotloop">If True, animation that does not play repeatedly is automatically terminated. (When Resume)</param>
		/// <returns>Animation data to be played. If it fails, null is returned.</returns>
		public apAnimPlayData PauseAt(	apAnimPlayData animPlayData, int frame,
									int layer = 0,
									apAnimPlayUnit.BLEND_METHOD blendMethod = apAnimPlayUnit.BLEND_METHOD.Interpolation,
									apAnimPlayManager.PLAY_OPTION playOption = apAnimPlayManager.PLAY_OPTION.StopSameLayer,
									bool isAutoEndIfNotloop = false)
		...
		/// </summary>
		/// <param name="optTextureName">Opt-Texture Name</param>
		/// <param name="texture">Texture to replace</param>
		/// <param name="propertyName">Shader Property Name</param>
		public void SetMeshCustomImageAll(string optTextureName, Texture texture, string propertyName)
		{
#if UNITY_EDITOR
			try
			{
		...
		public void SetMeshCustomImageAll(string optTextureName, Texture texture, int propertyNameID)//ID를 사용한 버전 [v1.4.3]
		{
#if UNITY_EDITOR
			try
			{
		...
		/// <param name="texture">Texture to replace</param>
		/// <param name="propertyName">Shader Property Name</param>
		public void SetMeshCustomImage(apOptTransform optTransform, Texture texture, string propertyName)
		{
#if UNITY_EDITOR
			try
			{
		...
		/// <param name="texture">Texture to replace</param>
		/// <param name="propertyName">Shader Property Name</param>
		public void SetMeshCustomImage(string transformName, Texture texture, string propertyName)
		{
#if UNITY_EDITOR
			try
			{
		...
		/// <param name="texture">Texture to replace</param>
		/// <param name="propertyName">Shader Property Name</param>
		public void SetMeshCustomImage(int rootUnitIndex, string transformName, Texture texture, string propertyName)
		{
#if UNITY_EDITOR
			try
			{
		...
		/// <param name="texture">Texture to replace</param>
		/// <param name="propertyNameID">Shader Property Name ID. Use Shader.PropertyToID to get it.</param>
		public void SetMeshCustomImage(apOptTransform optTransform, Texture texture, int propertyNameID)
		{
#if UNITY_EDITOR
			try
			{
		...
		/// <param name="texture">Texture to replace</param>
		/// <param name="propertyNameID">Shader Property Name ID. Use Shader.PropertyToID to get it.</param>
		public void SetMeshCustomImage(string transformName, Texture texture, int propertyNameID)
		{
#if UNITY_EDITOR
			try
			{
		...
		/// <param name="texture">Texture to replace</param>
		/// <param name="propertyNameID">Shader Property Name ID. Use Shader.PropertyToID to get it.</param>
		public void SetMeshCustomImage(int rootUnitIndex, string transformName, Texture texture, int propertyNameID)
		{
#if UNITY_EDITOR
			try
			{
		...
		/// <param name="propertyName">Shader Property Name</param>
		public void SetMeshCustomImageAll(Texture texture, string propertyName)
		{
#if UNITY_EDITOR
			try
			{
		...
		/// <param name="texture">Image Texture</param>
		/// <param name="propertyNameID">Shader Property Name ID. Use Shader.PropertyToID to get it.</param>
		public void SetMeshCustomImageAll(Texture texture, int propertyNameID)//ID를 사용한 버전 [v1.4.3]
		{
#if UNITY_EDITOR
			try
			{
