...
namespace AnyPortrait
{
	...
	public class apOptMergedMaterial
	{
		...
		public class MeshInfo
		{
			...
			public void SetCustomImage(Texture texture, ref string propertyName)
			{
				if(_isMerged)
				{
			...
			//변경 v1.6.2 : Texture2D > Texture
			public void SetCustomImage(Texture texture, int propertyNameID)//ID를 사용한 버전 [v1.4.3]
			{
				if(_isMerged)
				{
		...
		public class ShaderChannelInfo
		{
			...
			//변경 v1.6.2 : Texture2D > Texture
			public void SetCustomImage(Texture texture, int propertyNameID)//ID 버전 [v1.4.3]
			{
