...
namespace AnyPortrait
{
	...
	public class apOptTextureData
	{
		...
		public void SetCustomImageAll(Texture texture, string propertyName)//v1.6.2 Texture2D > Texture
		{
			if(_linkedOptMeshes == null || _linkedOptMeshes.Count == 0) { return; }
		...
		public void SetCustomImageAll(Texture texture, int propertyNameID)//v1.6.2 Texture2D > Texture
		{
			if(_linkedOptMeshes == null || _linkedOptMeshes.Count == 0) { return; }
