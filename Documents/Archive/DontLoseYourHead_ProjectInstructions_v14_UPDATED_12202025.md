...
Examples:
- `ProjectInstructions_v14_UPDATED_12202025.md`
- `ProjectInstructions_v15_UPDATED_12202025.md` (second update same day)
- `GDD_v14_UPDATED_12202025.md`
- `DLYH_Architecture_v14_UPDATED_12202025.md`
...
### Main Menu Trivia Display [NEW v14]

The `MainMenuController.cs` now includes rotating trivia facts displayed on the main menu:

**Features:**
- 25 historical facts about guillotines and beheadings
- Fades in, displays for 5 seconds, fades out
