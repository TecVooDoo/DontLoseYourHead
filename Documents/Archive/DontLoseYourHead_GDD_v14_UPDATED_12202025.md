...
### Main Menu Phase
Players can start a new game, access settings, submit feedback, or exit. The main menu displays rotating historical trivia facts about guillotines and beheadings.
...
### Trivia Display [NEW v14]
- Rotating historical facts about guillotines and beheadings
- 25 facts cycle with fade in/out transitions
- 5 second display per fact (configurable)
...
## Message Popup System [UPDATED v14]

### Purpose
Displays turn notifications, guess results, and game over messages to players.

### Positioning [UPDATED v14]
- **Default position:** Bottom of gameplay area - keeps popup out of the way
- **Draggable:** Players can drag the popup to their preferred location
- **Position memory:** Dragged position is remembered for subsequent popups during the same game
- **New game reset:** Position memory resets when starting a new game

### Behaviors
- Regular messages auto-fade after 2 seconds
- Game over messages persist until Continue button is clicked
- Dragging during auto-fade resets the timer
...
## Telemetry System [UPDATED v13]

### Purpose
Track playtest data for game balance analysis and player feedback collection.
...
### Game Abandon Tracking [NEW v13]
Captures when players quit mid-game:
- **Phase "gameplay":** Player clicked Return to Setup during a game
- **Phase "quit":** Player closed the browser/app during a game
- Includes turn number when abandoned

### Editor Dashboard [NEW v13]
Developers can view telemetry data in Unity Editor:
- **Menu:** DLYH > Telemetry Dashboard
- **Tabs:** Summary, Game Stats, Recent Events, Feedback
- **Export:** CSV export of all data
...
| Message popup position | Bottom of screen by default; remembers player's dragged position [UPDATED v14] |
| Main menu trivia | Rotating historical facts add thematic flavor [NEW v14] |
...
| Background music (MusicManager) | COMPLETE |
| Dynamic music tempo | COMPLETE |
| Mute buttons during gameplay | COMPLETE |
| Telemetry Dashboard (Editor window) | COMPLETE |
| Enhanced telemetry (player name, game abandon) | COMPLETE |
| MessagePopup positioning (bottom of screen) | COMPLETE [UPDATED v14] |
| Main menu trivia display | COMPLETE [NEW v14] |
