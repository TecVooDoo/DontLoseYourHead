...
Assets/DLYH/Scripts/
  ...
  UI/
    ...
    GridCellUI.cs
    Controllers/
      LetterTrackerController.cs (NEW Dec 5)
      GridColorManager.cs (NEW Dec 5)
      PlayerColorController.cs (NEW Dec 5)
    Services/
      WordValidationService.cs (NEW Dec 5)
```
