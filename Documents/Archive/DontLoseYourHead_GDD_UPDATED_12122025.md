...
### Phase 2.6: Pre-AI Features - TODO

- [ ] Autocomplete row dropdowns (scripts and prefab exist, need implementation)
- [ ] Main Menu completion
- [ ] Settings Panel (audio controls - SFX and Music, default 50% volume)
...
| Issue | Notes |
|-------|-------|
| Autocomplete row dropdowns | Scripts and prefab exist, need integration |
| Main Menu | Needs completion |
| Settings Panel | Audio controls for SFX and Music |
