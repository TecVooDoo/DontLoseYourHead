...
**21. Store Original Positions for Reset [NEW v16]**
...
**22. Kill DOTween Before Reset [NEW v16]**
...
**23. Scene File Protection [NEW v16]**
...
## Bug Fix History (December 22, 2025) [NEW v16]
...
- Drug words added to banned list [v16]: heroin, cocaine, meth, crack, weed, opium, morphine, ecstasy, molly, dope, smack, coke
...
- ResetFace() restores to Neutral expression [v16]
...
## New Systems (December 22, 2025) [NEW v16]
...
| Final execution audio sequence (3-part) | Audio | COMPLETE [v15] |
| Drug word filtering | Content | COMPLETE [NEW v16] |
| Board reset on new game | Bug Fix | COMPLETE [NEW v16] |
| Settings button during gameplay | UX | COMPLETE [NEW v16] |
| Version display on main menu | UX | COMPLETE [NEW v16] |
...
### Remote Playtest Feedback (Dec 22, 2025) [NEW v16]
...
- Drug word filtering [v16]
- Board reset on new game [v16]
- Settings button during gameplay [v16]
- Version display on main menu [v16]
...
- All positions properly reset on new game [v16]
