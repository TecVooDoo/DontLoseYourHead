...
**Last Updated:** December 13, 2025 (v8 - REFACTORING PHASE COMPLETE)  
...
## Primary Goals (Reference)

### 1. Reduce Script Size for Tooling
**Target:** 1,000-1,200 lines for complex scripts, under 500 for simple ones.

### 2. Future Readability
Self-documenting code, clear naming, single responsibility.

### 3. Full Separation of Concerns
UI knows nothing about game logic. Communication through events and interfaces.

### 4. Memory Efficiency
Cache components, early-exit patterns, allocation-free hot paths.
