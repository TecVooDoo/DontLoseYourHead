...
**Examples:**
- `ProjectInstructions_UPDATED_12132025.md`
- `GDD_UPDATED_12132025.md`
...
**Main Menu and Settings Panel (Started Dec 13, 2025):**
- [X] MainMenuController.cs script created
- [X] SettingsPanel.cs script created (audio volume with PlayerPrefs)
- [ ] UI hierarchy creation in Unity
- [ ] Wire up button references
- [ ] Test navigation flow

### Next Development Priorities (Pre-AI)

**Immediate:**
1. Complete Main Menu UI hierarchy and wiring
2. Complete Settings Panel UI and integration
3. Test full game flow: Main Menu -> Setup -> Gameplay

### Phase 3: AI Opponent

4. AI opponent system
5. Win/Lose condition UI feedback
6. Turn indicator improvements

### Phase 4: Polish and Features

7. Visual polish (DOTween animations, Feel effects)
8. Audio implementation
9. Invalid word feedback UI (toast/popup)
10. Profanity filter for word bank
11. Medieval/carnival themed monospace font

### Phase 5: Multiplayer and Mobile

12. 2-player networking mode (human vs human online)
