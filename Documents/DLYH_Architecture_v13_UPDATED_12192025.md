...
+-- UI/
    ...
    |-- MessagePopup.cs                 (~450 lines) [UPDATED v13]
...
## Layer 9: MessagePopup System [UPDATED v13]
...
**v13 Updates:**
- Default position at top of screen (35% from top)
- Remembers dragged position via `_lastDraggedPosition` and `_hasBeenDragged`
- Game over messages always position at top
...
- `GetDefaultTopPosition()` - Returns top-of-screen position

**Static Methods:**
- `Show(string)`, `Show(string, float duration)`
- `ShowGameOver(string)`
- `ResetPosition()` [NEW v13]
