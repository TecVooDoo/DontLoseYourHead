...
## Message Popup System [UPDATED v13]

### Purpose
Displays turn notifications, guess results, and game over messages to players.

### Positioning [NEW v13]
- **Default position:** Top of screen (35% from top) - avoids covering center content
...
- **Game over messages:** Always appear at top so players can see guillotine animations
...
| Message popup position | Top of screen by default; remembers player's dragged position [NEW v13] |
