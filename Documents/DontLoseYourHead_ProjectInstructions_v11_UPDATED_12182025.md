...
Examples:
- `ProjectInstructions_v11_UPDATED_12182025.md`
- `ProjectInstructions_v12_UPDATED_12182025.md` (second update same day)
- `GDD_v11_UPDATED_12182025.md`
- `DLYH_Architecture_v11_UPDATED_12182025.md`
...
- **HeadFaceController needs Unity setup:** Add Face Image child to head, assign sprites [NEW v11]

## Current Work in Progress [NEW v11]
